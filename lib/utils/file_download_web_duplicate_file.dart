...
// import 'package:trail_tracker/models/shift_log_model.dart';
//
// Future<void> downloadFileFromUrl(String url) async {
//   try {
//     // Use HttpRequest to get arraybuffer (better for binary)
...
//       ..setAttribute('download', Uri.parse(url).pathSegments.isNotEmpty ? Uri.parse(url).pathSegments.last : 'file')
//       ..click();
//
//     html.Url.revokeObjectUrl(blobUrl);
//     // debug
//     // ignore: avoid_print
//     print('✅ Download started (web): $url');
//   } catch (e, st) {
//     // ignore: avoid_print
...
//       log.vehicleNo,
//       log.inTime?.toIso8601String() ?? '',
//       log.outTime?.toIso8601String() ?? '',
