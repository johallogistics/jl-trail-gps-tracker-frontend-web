        ...
        child: Column(
          children: [
            ...
            buildSectionCard('report_details'.tr, [
              ...
              buildReviewRow('odo_start_reading'.tr, s((m) => m?.startingKm.toString(), controller.startingKmController.text)),
              buildReviewRow('odo_end_reading'.tr, s((m) => m?.endingKm.toString(), controller.endingKmController.text)),
  ...
  Future<void> submitData(List<String> imageVideoUrls) async {
    ...
    if (widget.shiftLog != null) {
      ...
      payload = {
        ...
        'vehicleOdometerStartingReading': int.tryParse(controller.startingKmController.text) ?? 0,
        'vehicleOdometerEndingReading': int.tryParse(controller.endingKmController.text) ?? 0,
